...
First off, thank you for considering contributing to github-actions.
...
[issue tracker](https://github.com/daxartio/github-actions/issues),
...
```shell
git clone https://github.com/daxartio/github-actions
cd github-actions
cargo test
```
